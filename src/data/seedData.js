...
export const SEED_VENDORS = [
  {
    id: 'v1',
    name: 'Anshul Malhotra',
    shopName: 'Himachal Handlooms (Om Prakash Malhotra & Family)',
    phone: '+91 98160 45123',
    whatsapp: '919816045123',
    category: 'Textiles & Shawls',
    description:
      'We have been preserving the hand weaving culture in Mandi for generations. My father, Om Prakash Malhotra, is a Padma Awardee for his dedication to this craft. Featured in BeStorified: "How Anshul Malhotra preserves the beauty of Himachal handlooms" (https://share.google/JbtHO9Mu6bOuMFzfp).',
    image: '/images/shops/v1.png',
    products: [
      { name: 'Kullu Patti Shawl', price: '₹1,200', description: 'Traditional geometric pattern', image: '/images/products/v1_p1.png' },
      { name: 'Pashmina Stole', price: '₹2,500', description: 'Pure pashmina, hand-embroidered', image: '/images/products/v1_p2.png' },
      { name: 'Mandi Topi (Cap)', price: '₹350', description: 'Iconic Himachali cap', image: '/images/products/v1_p3.png' },
    ],
    createdAt: '2026-02-15T10:00:00',
  },
  {
    id: 'v2',
    name: 'Kullu Producers',
    shopName: 'Himalayan Dry Fruits',
    phone: '+91 94180 78456',
    whatsapp: '919418078456',
    category: 'Food & Pickles',
    description:
      'Partnering with Himalayan Dry Fruits Kullu to bring you authentic mountain flavours. We offer premium quality nuts and dried fruits sourced directly from the local orchards of Himachal Pradesh.',
    image: '/images/milestones/himalayan_dry_fruits.jpg',
    products: [
      { name: 'Himachali Akhrot (Walnuts)', price: '₹600/kg', description: 'Premium paper-shell walnuts from Kullu', image: '/images/products/v2_p1.png' },
      { name: 'Dried Himalayan Apples', price: '₹350/250g', description: 'Sun-dried sweet apples, no added sugar', image: '/images/products/v2_p2.png' },
      { name: 'Chilgoza (Pine Nuts)', price: '₹1200/250g', description: 'Rare pine nuts from Kinnaur region', image: '/images/products/v2_p3.png' },
    ],
  ...
  },
  {
    ...
    image: '/images/shops/v3.png',
    products: [
      { name: 'Wild Oregano (Ban Tulsi)', price: '₹150/100g', description: 'Hand-picked from high altitudes', image: '/images/products/v3_p1.png' },
      { name: 'Himalayan Turmeric', price: '₹120/100g', description: 'Organic, stone-ground', image: '/images/products/v3_p2.png' },
      { name: 'Pink Rock Salt', price: '₹80/250g', description: 'From local salt mines', image: '/images/products/v3_p3.png' },
    ],
  ...
  },
  {
    ...
    image: '/images/shops/v4.png',
    products: [
      { name: 'Deodar Temple Replica', price: '₹3,500', description: 'Miniature Hidimba temple', image: '/images/products/v4_p1.png' },
      { name: 'Walnut Wood Bowl Set', price: '₹1,800', description: 'Set of 4, hand-carved', image: '/images/products/v4_p2.png' },
      { name: 'Wooden Spice Box', price: '₹900', description: 'Traditional masala dabba', image: '/images/products/v4_p3.png' },
    ],
  ...
  },
  {
    ...
    image: '/images/shops/v5.png',
    products: [
      { name: 'Beas River Watercolor', price: '₹4,000', description: 'Original 12x18 inch painting', image: '/images/shops/v5.png' },
      { name: 'Temple Series Print', price: '₹800', description: 'Set of 3 A4 prints', image: '/images/shops/v5.png' },
      { name: 'Custom Portrait', price: '₹2,500', description: 'Acrylic on canvas, any size', image: '/images/shops/v5.png' },
    ],
